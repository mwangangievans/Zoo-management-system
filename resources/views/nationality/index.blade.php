...
<div class="col-lg-10 col-lg-offset-1">
  <h3 class="info">nationality </h3>
  @role(['Admin'])
 @if (!Auth::guest())

<button type="button" class="btn btn-primary non_printable" data-toggle="modal" data-target="#nationality">
  <h4 class="non_printable">Add nationality</h4>
</button>
 @endif
@endrole

<div class="modal fade non_printable" id="nationality" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="ticket">
    <form method="POST" action="{{ route('nationality.store') }}" class="formless" >   
